<template>
    <div class="modal fade" id="RuleCreate">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="col-md-8 offset-md-2 col-10 offset-1">
                        <input type="submit" v-on:click.prevent="addRule"  class="btn btn-primary" value="Guardar">
                    </div>
                </div>
			</div>
		</div>
        ...
        methods: {
            ...
            addRule: function(){
                ...
                axios.post(urlDetail,_this.info).then(response => {
                	...
                	toastr.success('Regla creada satisfactoriamente');
                    _this.$emit('saved');
                }).catch(function(error){
                    console.log(error);
                    toastr.error('No se pudo cargar la información');
