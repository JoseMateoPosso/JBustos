	...
	<div id="nicksLogic" class="col-md-12 col-xs-12 col-lg-12">
		<div class="row">
	        <div class="col-md-12 col-xs-12 col-lg-12">
	            <h1 class="page-header">ARL</h1>
	            <div class="float-right">
	                <a href="#" class="btn btn-info btn-md" title="Nueva" v-on:click.prevent="showAddForm">Nueva ARL</a>
	            </div>
	        </div>
	        <div class="col-md-12 col-xs-12 col-lg-12">
...
<script>
    ...
    import editInfo from './EditArl';
    import addInfo from './AddArl';
    ...
    export default {
        ...
        methods: {
            getInfo: function(){
                ...
                axios.post(urlDetail,{'category_id':24}).then(response => {
            ...
            hideAddForm: function(){
                this.getInfo();
                $('#ArlCreate').modal('hide');
            },
            showAddForm: function(info){
                $('#ArlCreate').modal('show');
            },
