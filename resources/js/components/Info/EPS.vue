	...
	<div id="nicksLogic" class="col-md-12 col-xs-12 col-lg-12">
		<div class="row">
	        <div class="col-md-12 col-xs-12 col-lg-12">
	            <h1 class="page-header">EPS</h1>
	            <div class="float-right">
	                <a href="#" class="btn btn-info btn-md" title="Nueva" v-on:click.prevent="showAddForm">Nueva EPS</a>
	            </div>
	        </div>
	        <div class="col-md-12 col-xs-12 col-lg-12">
...
<script>
    ...
    import editInfo from './EditEps';
    import addInfo from './AddEps';
    ...
    export default {
        ...
        methods: {
            getInfo: function(){
                ...
                axios.post(urlDetail,{'category_id':23}).then(response => {
