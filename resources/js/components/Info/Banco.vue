		...
		<div class="row">
	        <div class="col-md-12 col-xs-12 col-lg-12">
	            ...
	            <div class="float-right">
	                <a href="#" class="btn btn-info btn-md" title="Nueva" v-on:click.prevent="showAddForm">Nuevo Banco</a>
	            </div>
	        </div>
	        <div class="col-md-12 col-xs-12 col-lg-12">
...
<script>
    ...
    import editInfo from './EditBanco';
    import addInfo from './AddBanco';
    ...
    export default {
        ...
        methods: {
            getInfo: function(){
                ...
                axios.post(urlDetail,{'category_id':26}).then(response => {
            ...
            hideAddForm: function(){
                this.getInfo();
                $('#BancoCreate').modal('hide');
            },
            showAddForm: function(info){
                $('#BancoCreate').modal('show');
            },
