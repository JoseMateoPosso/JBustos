<template>
    <div class="modal fade" id="PageCreate">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="col-md-8 offset-md-2 col-10 offset-1">
                        <input type="submit" v-on:click.prevent="addPage"  class="btn btn-primary" value="Guardar">
                    </div>
                </div>
			</div>
		</div>
        ...
        methods: {
            ...
            addPage: function(){
                ...
                if(_this.info.category_id == ''){
                    toastr.error('La categoría es obligatoria');
                    return;
                }
                ...
                axios.post(urlDetail,_this.info).then(response => {
                	...
                	toastr.success('Página creada satisfactoriamente');
                    _this.$emit('saved');
                }).catch(function(error){
                    console.log(error);
                    toastr.error('No se pudo cargar la información');
